...
const Page2 = () => {
  ...
  return (
    <div id="section2" className="text-center text-black bg-white p-10">
      <h3 className=" text-[#696969] font-[anzo3]">© anzo.studio 2024 | designed and developed</h3>
      <div className="rotateText mt-16">
        <h1 className="text-[42vw] text-black font-[anzo2] uppercase leading-[33vw]">IMPACTFUL</h1>
      </div>
      <div className="rotateText">
        <h1 className="text-[42vw] text-black font-[anzo2] uppercase leading-[33vw]">design</h1>
      </div>
      <div className="rotateText">
        <h1 className="text-[42vw] text-black font-[anzo2] uppercase leading-[33vw]">is the</h1>
      </div>
      <div className="rotateText">
        <h1 className="text-[42vw] text-black font-[anzo2] uppercase leading-[33vw]">design</h1>
      </div>
      <div className="rotateText">
        <h1 className="text-[42vw] text-black font-[anzo2] uppercase leading-[33vw]">that</h1>
      </div>
      <div className="rotateText">
        <h1 className="text-[42vw] text-black font-[anzo2] uppercase leading-[33vw]">works!</h1>
      </div>
    ...
    <g>
      ...
      <div className="h-0.5 w-1/3 bg-black mt-16 relative left-1/2 -translate-x-1/2"></div>
    </div>
  );
};
